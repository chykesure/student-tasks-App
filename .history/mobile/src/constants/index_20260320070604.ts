...
export const API_CONFIG = {
  ...
  BASE_URL: 'http://10.0.2.2:5000/api', // Android emulator default
...
export const API_CONFIG = {
  // For physical device on same network (your current Wi-Fi/hotspot IP)
  BASE_URL: 'http://172.20.10.3:5000/api',

  // Keep comments for reference
  // 'http://10.0.2.2:5000/api' → Android emulator only
  // 'http://localhost:5000/api' → iOS simulator only
